...
<script language="javascript" type="text/javascript">
	...
	function doClick(v1){		
        ...
        window.opener.document.nPSBEremitTransactionStatusUpdateForm.transactionAmount.value = "99";		
		window.close();
          ...
          <tr>
            ...
            <!--        <th width="4%" align="center" valign="middle" class="lbl-b-08"  style="height: 35">Srl</th>-->
              ...
              <!--                <td valign="top" class="lbl-08"  align="center"><core:out value="${indexCustomerList.serialNo}"/></td>-->
                          ...
                          <td align="center" valign="top" class="lbl-08"><a href="#" onClick="doClick('${indexCustomerList.transactionID}','${indexCustomerList.transactionAmount}')">
                       select</a></td>
                        </tr>
                      </core:forEach>
                    </table></td>

    ...
    <tr>
      <td valign="top">
          ...
          <tr>
            ...
            <td>&nbsp;</td>
            <td><html:text property="transactionID" styleClass="txt-n" readonly="true" style="width:210px"/>  
          ...
          <tr class="spaceUnder">
            ...
            <td>&nbsp;</td>
            <td><html:text property="transactionAmount" styleClass="txt-n" style="width:210px"/></td>
            <td>&nbsp;</td>
            </tr>

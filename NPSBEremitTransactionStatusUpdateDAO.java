...
public class NPSBEremitTransactionStatusUpdateDAO {
	...
	public NPSBEremitTransactionStatusUpdateBO getNPSBeRemitAPI(NPSBEremitTransactionStatusUpdateBO model) {
		...
		//NPSBEremitTransactionStatusUpdateBO outModel = new NPSBEremitTransactionStatusUpdateBO();
		NPSBEremitTransactionStatusUpdateBO oNPSBEremitTransactionStatusUpdateBO = new NPSBEremitTransactionStatusUpdateBO();
		...
		try {
			...
			if (status == 200) {
			    ...
			    //ArrayList<NPSBEremitTransactionStatusUpdateBO> bo = responseNPSBeRemitAPI(model);
				//System.out.println("ErrorCode 111 =>" + bo.getErrorCode());
				//System.out.println("ErrorMessage 111 =>" + bo.getErrorMessage());

				//oNPSBEremitTransactionStatusUpdateBO.setErrorCode(bo.getErrorCode());
				//oNPSBEremitTransactionStatusUpdateBO.setErrorMessage(bo.getErrorMessage());
				//return oNPSBEremitTransactionStatusUpdateBO;
	...
	public NPSBEremitTransactionStatusUpdateBO responseNPSBeRemitAPI(NPSBEremitTransactionStatusUpdateBO model) {
		...
		// ArrayList<NPSBEremitTransactionStatusUpdateBO>  list = new ArrayList<NPSBEremitTransactionStatusUpdateBO>();
		 NPSBEremitTransactionStatusUpdateBO oNPSBEremitTransactionStatusUpdateBO = new NPSBEremitTransactionStatusUpdateBO();
		...
		try {
			...
			if (status == 200) {
				...
				if (obj.has("apiData") && !obj.isNull("apiData")) {
					org.json.JSONArray apiDataObj = obj.getJSONArray("apiData");
					...
					for (int i = 0; i < apiDataObj.length(); i++) {
						...
						aTmpList.add(oNPSBOutgoingReversalReverseListBO);
						//System.out.println("list====>>>>"+aTmpList);						
